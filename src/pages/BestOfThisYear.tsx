...
function BestOfThisYear() {
    ...
    const dateEnd = new Date(currentDate.getFullYear(), 11, 31);
    ...
    return (
        <main className="p-4 ml-4 sm:ml-64 sm:mt-6">
            <div className="pb-5">
                <h1 className="text-7xl font-bold pb-5">Best of this year</h1>
            </div>
